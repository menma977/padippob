...
class BalanceController(private val username : String, private val code : String) : AsyncTask<Void, Void, JSONObject>() {
    override fun doInBackground(vararg params: Void?): JSONObject {
        try {
            val userAgent = "Mozilla/5.0"
            val url = URL("https://padippob.com/api/ceksaldo.php")
            ...
            val urlParameters = "a=CekSaldo&username=${username}&idlogin=${code}"
