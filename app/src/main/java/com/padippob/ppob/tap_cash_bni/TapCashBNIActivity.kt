package com.padippob.ppob.tap_cash_bni
...
import com.padippob.ppob.pln.PLNValidationActivity
import kotlinx.android.synthetic.main.activity_tap_cash_bni.*
import java.text.NumberFormat
import java.util.*
import kotlin.collections.ArrayList

class TapCashBNIActivity : AppCompatActivity() {

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tap_cash_bni)
        ...
        val arrayProduct = responseProduct.getJSONObject(0).getJSONArray("ETOLL")
