...
import kotlinx.android.synthetic.main.activity_post_paid_credit_validation.*
import org.json.JSONObject
import java.text.NumberFormat
import java.util.*

class PostPaidCreditValidationActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_post_paid_credit_validation)
