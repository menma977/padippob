package com.padippob.ppob.grab
...
import kotlinx.android.synthetic.main.activity_garb_validation.*
import org.json.JSONObject
import java.text.NumberFormat
import java.util.*

class GrabValidationActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_garb_validation)
